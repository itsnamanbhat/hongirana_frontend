    ...
    <React.Fragment>
      { showCode &&
        <Modal
          show={showCode}
          onCancel={closeCode}
          footer={<Button onClick={closeCode}>Close</Button>}
        >
      ...
      <div className="donate_main">
        ...
        <div className="donate_s2">
          <div className="donate_impact">
            ...
            <h4>
              By donating to our charity, you are directly contributing to
            </h4>
            <ul>
        ...
        <button className="donate_button" onClick={openCode}>
          Donate
        </button>
      </div>
    </React.Fragment>
